...
The repository holds the canonical GitHub Sponsors page for @psyb0t, maintained
as a README: the sponsorship tiers (monthly and one-time), a Monero option, and
placeholder sections for current and past sponsors.
